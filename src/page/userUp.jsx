...
const SignUp = () => {
   ...
   const putHandler = async () => {
      try {
         ...
         const response = await customAxios.put('/users/edit', {
            password,
            name,
            gender,
            birth,
   ...
   return (
      <div style={{ width: '100%', height: '100%', position: 'relative', background: '#D6E0F2' }}>
         ...
         <button onClick={putHandler} style={{ width: 170, height: 60, left: 875, top: 850, position: 'absolute', background: '#587BF7', borderRadius: 20, color: '#FEFCFC', fontSize: 26, fontFamily: 'Pretendard', fontWeight: '700', wordWrap: 'break-word', cursor: 'pointer' }}>확인</button>
         ...
         <div style={{ width: 556, height: 80, left: 682, top: 294, position: 'absolute', textAlign: 'center', color: 'white', fontSize: 40, fontFamily: 'Pretendard', fontWeight: '700', wordWrap: 'break-word' }}>회원 정보 수정<br /></div>
      </div>
   );
}
